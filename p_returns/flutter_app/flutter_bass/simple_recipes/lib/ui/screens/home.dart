...
import 'package:simple_recipes/utils/store.dart';
import 'package:simple_recipes/ui/widgets/recipe_card.dart';
import 'package:simple_recipes/model/state.dart';
              ...
              child: ListView.builder(
                ...
                itemBuilder: (BuildContext context, int index) {
                  return new RecipeCard(
                    ...
                    inFavourites: userFavorites.contains(recipesList[index].id),
                    onFavouriteButtonPressed: _handleFavoritesListChanged,
                  );
                },
              ),
            ),
