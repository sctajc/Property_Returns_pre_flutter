...
class PropertyDetails2 extends StatefulWidget {
  final String propertyId;
  PropertyDetails2(this.propertyId);

  @override
  _PropertyDetails2State createState() => _PropertyDetails2State();
}

class _PropertyDetails2State extends State<PropertyDetails2> {
